...
<template>
  <div class="flex flex-col items-center justify-center min-h-screen-nonav">
    ...
    <form @submit.prevent="logginIn" class="flex flex-col p-4 space-y-4">
        ...
        <button type="submit" @submit.prevent="logginIn" class="w-1/2 py-2 text-green-200 bg-green-600 rounded-lg" >Login</button>   
        
        <button @click="signingUp" class="w-1/2 py-2 text-purple-200 bg-purple-600 rounded-lg" >Sign Up</button>   
        </div>
    <button @click="google"
