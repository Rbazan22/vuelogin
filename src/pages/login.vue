...
<template>
  <div class="flex flex-col items-center justify-center min-h-screen-nonav">
    ...
    <form @submit.prevent="logginIn" class="flex flex-col p-4 space-y-4">
        ...
        name="username" 
        type="text" 
        class="p-2 border-2 rounded-lg" placeholder="Enter Email" 
        v-model="username" 
        />
        ...
        name="password"
        type="password" 
        class="p-2 border-2 rounded-lg" placeholder="Enter Password" 
        v-model="password" 
        />
        ...
        class="w-1/2 py-2 text-green-200 bg-green-600 rounded-lg hover:bg-green-700" >Login</button>   
        
        <button @click="signingUp" class="w-1/2 py-2 text-purple-200 bg-purple-600 rounded-lg hover:bg-purple-700" >Sign Up</button>   
        </div>
    <button @click="google"
